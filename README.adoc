...
image:https://img.shields.io/maven-central/v/de.cuioss.jwt/cui-jwt.svg?label=Maven%20Central["Maven Central", link="https://search.maven.org/artifact/de.cuioss.jwt/cui-jwt"]
image:https://sonarcloud.io/api/project_badges/measure?project=cuioss_cui-jwt&metric=alert_status[Quality Gate Status,link=https://sonarcloud.io/summary/new_code?id=cuioss_cui-jwt]
image:https://sonarcloud.io/api/project_badges/measure?project=cuioss_cui-jwt&metric=ncloc[Lines of Code,link=https://sonarcloud.io/summary/new_code?id=cuioss_cui-jwt]
image:https://sonarcloud.io/api/project_badges/measure?project=cuioss_cui-jwt&metric=coverage[Coverage,link=https://sonarcloud.io/summary/new_code?id=cuioss_cui-jwt]
