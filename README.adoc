...
* *Security*: link:doc/threat-model/Threat-Model.adoc[Threat Model], link:doc/specification/security.adoc[Security Specification]
...
For more details on security considerations, see the link:doc/threat-model/Threat-Model.adoc[Threat Model] and link:doc/specification/security.adoc[Security Specification].
