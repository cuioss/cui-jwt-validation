...
/**
 * Simple tests for {@link JwtValidationConfig} using a programmatically created configuration.
 * This approach avoids the issues with ConfigMapping in tests.
 * 
 * Note: Using direct instantiation instead of Quarkus CDI to avoid initialization issues.
 */
@DisplayName("Tests JwtValidationConfig with programmatic configuration")
class JwtValidationConfigSimpleTest {
