...
For detailed information about security testing, including test classes, test coverage, and specific security tests like Key Disclosure Vulnerability Tests and Token Cracking Resistance Tests, please refer to the link:security-specifications.adoc[Security] document, specifically the "Security Testing Specifications" section.
...
For detailed information about dependency management and vulnerability scanning, please refer to the link:security-specifications.adoc[Security] document, specifically the "Dependency Management" section.
