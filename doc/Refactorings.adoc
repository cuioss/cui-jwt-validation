...
* [ ] The implementation will follow these steps:
  * [ ] Compare the content of the new response with the stored originalString
  * [ ] If the content is the same, return the previously created JWKSKeyLoader
  * [ ] If the content is different, create a new JWKSKeyLoader with the new content

=== Fallback Mechanism
* [ ] The implementation will follow these steps:
  * [ ] Store the last valid JWKSKeyLoader in the lastValidResult field
