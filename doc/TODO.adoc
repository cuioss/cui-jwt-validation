...
[ ] Create and implement consistent patterns for initializing token generators.
...
[ ] Create clear documentation on when to use each type of generator and how to configure them.
