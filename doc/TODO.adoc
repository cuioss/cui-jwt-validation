...
4. [ ] Link to relevant test classes and or documentation that verify the mitigation
5. [ ] Update the corresponding sections in link:security/oauth-security-analysis.adoc[oauth-security-analysis.adoc] to ensure consistency
