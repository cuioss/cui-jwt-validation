...
* link:../jwt-security-best-practices.adoc[JWT Security Best Practices Guide] - Comprehensive guide on JWT security best practices
...
* For a comprehensive analysis of common JWT vulnerabilities and attacks, see the link:jwt-attacks-analysis.adoc[JWT Vulnerabilities and Attacks Analysis] document.
* For a comprehensive analysis of OAuth-related security vulnerabilities, see the link:oauth-security-analysis.adoc[OAuth Security Considerations Analysis] document.
* For application-level security guidance and best practices, see the link:../jwt-security-best-practices.adoc[JWT Security Best Practices Guide].
...
* link:../../src/main/java/de/cuioss/jwt/validation/jwks/JwksLoader.java[JwksLoader] - Interface for loading JWKS (JSON Web Key Set)
* link:../../src/main/java/de/cuioss/jwt/validation/jwks/http/HttpJwksLoader.java[HttpJwksLoader] - Implementation for loading JWKS from HTTP endpoints
* link:../../src/main/java/de/cuioss/jwt/validation/jwks/file/FileSystemJwksLoader.java[FileSystemJwksLoader] - Implementation for loading JWKS from the file system
* link:../../src/main/java/de/cuioss/jwt/validation/jwks/cache/CachedJwksLoader.java[CachedJwksLoader] - Implementation that adds caching to any JwksLoader
* link:../../src/main/java/de/cuioss/jwt/validation/jwks/multi/MultiSourceJwksLoader.java[MultiSourceJwksLoader] - Implementation that aggregates multiple JwksLoader instances
...
* link:../../src/test/java/de/cuioss/jwt/validation/jwks/http/HttpJwksLoaderTest.java[HttpJwksLoaderTest] - Tests for loading JWKS from HTTP endpoints
* link:../../src/test/java/de/cuioss/jwt/validation/jwks/file/FileSystemJwksLoaderTest.java[FileSystemJwksLoaderTest] - Tests for loading JWKS from the file system
* link:../../src/test/java/de/cuioss/jwt/validation/jwks/cache/CachedJwksLoaderTest.java[CachedJwksLoaderTest] - Tests for JWKS caching
* link:../../src/test/java/de/cuioss/jwt/validation/jwks/multi/MultiSourceJwksLoaderTest.java[MultiSourceJwksLoaderTest] - Tests for multiple JWKS sources
* link:../../src/test/java/de/cuioss/jwt/validation/security/KeyInjectionAttackTest.java[KeyInjectionAttackTest] - Tests for protection against key ID injection attacks
* link:../../src/test/java/de/cuioss/jwt/validation/security/EmbeddedJwkAttackTest.java[EmbeddedJwkAttackTest] - Tests for protection against embedded JWK attacks
* link:../../src/test/java/de/cuioss/jwt/validation/security/JkuX5uAttackTest.java[JkuX5uAttackTest] - Tests for protection against JKU/X5U header abuse
