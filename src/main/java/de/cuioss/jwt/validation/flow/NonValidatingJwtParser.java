 ...
 * <pre>
 * // Create a parser with custom security settings using TokenValidatorConfig
...
public class NonValidatingJwtParser {
     ...
     */
    @Builder.Default
    private final TokenValidatorConfig config = TokenValidatorConfig.builder().build();
