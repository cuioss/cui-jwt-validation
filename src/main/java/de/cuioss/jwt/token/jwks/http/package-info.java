 ...
 * <ul>
 *   <li>{@link de.cuioss.jwt.token.jwks.http.HttpJwksLoader} - Main component that implements 
 *       {@link de.cuioss.jwt.token.jwks.JwksLoader} for HTTP-based JWKS sources</li>
 *   <li>{@link de.cuioss.jwt.token.jwks.http.HttpJwksLoaderConfig} - Configuration parameters 
 *       for the HTTP JWKS loader</li>
 *   <li>{@link de.cuioss.jwt.token.jwks.http.JwksHttpClient} - Client for making HTTP requests 
 *       to JWKS endpoints</li>
 *   <li>{@link de.cuioss.jwt.token.jwks.http.JwksCacheManager} - Manages caching of JWKS keys</li>
 *   <li>{@link de.cuioss.jwt.token.jwks.http.BackgroundRefreshManager} - Manages background 
