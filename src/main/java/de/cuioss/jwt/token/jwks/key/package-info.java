 ...
 * Key components:
 * <ul>
 *   <li>{@link de.cuioss.jwt.token.jwks.key.KeyInfo} - Holds information about a key, including the key itself and its algorithm</li>
 *   <li>{@link de.cuioss.jwt.token.jwks.key.JwkKeyConstants} - Constants for JWK key properties</li>
 *   <li>{@link de.cuioss.jwt.token.jwks.key.JwkKeyHandler} - Handles parsing and conversion of JWK keys</li>
 *   <li>{@link de.cuioss.jwt.token.jwks.key.JWKSKeyLoader} - Loads and manages keys from a JWKS</li>
 * </ul>
 * <p>
 ...
 * 
 * @since 1.0
 * @see de.cuioss.jwt.token.jwks.JwksLoader
