...
public class ClaimControlParameter {
    ...
    /**
     * @return whether the token should be expired
     */
    ...
    /**
     * @return whether the token type claim should be missing
     */
    ...
    /**
     * Creates default parameters for a valid token of the given type.
     * This method sets appropriate defaults based on the token type.
     *
    ...
    public static class Builder {
        private String tokenPrefix = "valid-token-";
        ...
        /**
         * Sets whether the token should be expired.
         *
         * @param expiredToken true if the token should be expired
         * @return this builder for method chaining
         */
        ...
        /**
         * Sets whether the token type claim should be missing.
         *
         * @param missingTokenType true if the token type claim should be missing
         * @return this builder for method chaining
         */
