...
class RFC7519JWTComplianceTest {
    ...
    class TokenValidationTests {
        ...
        @Test
        @DisplayName("7.2: Reject token with invalid signature")
        void shouldRejectInvalidSignature() {

            // Create a token with an invalid signature by using a different key to sign it
            ...
            // When
            Optional<AccessTokenContent> result = tokenFactory.createAccessToken(invalidToken);
