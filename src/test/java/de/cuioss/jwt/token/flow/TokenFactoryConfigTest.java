...
/**
 * Tests for {@link TokenFactoryConfig}.
 */
@EnableTestLogger
@DisplayName("Tests for TokenFactoryConfig")
class TokenFactoryConfigTest {
    ...
    void shouldCreateConfigWithDefaultValues() {
        ...
        // Then
        assertEquals(TokenFactoryConfig.DEFAULT_MAX_TOKEN_SIZE, config.getMaxTokenSize());
        assertEquals(TokenFactoryConfig.DEFAULT_MAX_PAYLOAD_SIZE, config.getMaxPayloadSize());
        assertEquals(TokenFactoryConfig.DEFAULT_MAX_STRING_SIZE, config.getMaxStringSize());
        assertEquals(TokenFactoryConfig.DEFAULT_MAX_ARRAY_SIZE, config.getMaxArraySize());
        assertEquals(TokenFactoryConfig.DEFAULT_MAX_DEPTH, config.getMaxDepth());
